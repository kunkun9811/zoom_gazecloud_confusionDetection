(function () {
  ...
  // NOTE: get meeting args from url
  var tmpArgs = testTool.parseQuery();
  // NOTE: meeting configuration
  var meetingConfig = {
  ...
  // NOTE: a tool use debug mobile device
  ...
  function beginJoin(signature) {
    ...
    // NOTE: All zoom meetings listeners for logging in the console
