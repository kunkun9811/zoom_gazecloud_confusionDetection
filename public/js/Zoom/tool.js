/* NOTE: These tools are basically helper funcitons for joining a zoom meeting */
var testTool = {
  ...
  // NOTE: helper function to get ALL info about the meeting configuration from USER INPUT
  ...
  parseQuery: function () {
    return (function () {
      ...
      for (var i = 0; i < pairs.length; i += 1) {
        ...
        // ["var1", "1"]
        // NOTE: decode the encoded URI components
